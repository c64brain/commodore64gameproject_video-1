...
;===================================================================================================
        ...
        ldx #50                          ; Y start pos (in tile coords) (129,26=default)
...
MAP_MEM
incbin"/Robocop/map1.bin"


ATTRIBUTE_MEM
incbin"/Robocop/chsetattrib1.bin"

TILE_MEM
incbin"/Robocop/tileset1.bin"
